...
public:
    ...
    Conv conv2;
    BatchNorm bn2;
    BasicBlock(unsigned int C1,unsigned int N1,unsigned int N2, unsigned int height, unsigned int width,
...
public:
    ...
    Conv conv3;
    BatchNorm bn3;
    BasicBlock_Downsample(unsigned int C1,unsigned int N1,unsigned int N2, unsigned int N3, unsigned int height, unsigned int width,
                          string conv1_weight, string conv2_weight, string conv3_weight, string bn1_weight, string bn2_weight, string bn3_weight);
    Add add;
    float *forward(float *x);
};
